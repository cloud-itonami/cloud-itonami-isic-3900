# Operator Quickstart — Remediation Activities & Other Waste Management Services Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 3900** (`cloud-itonami-isic-3900`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3900.git
cd cloud-itonami-isic-3900
```
...
- Blueprint governor key: `site-remediation-ops-governor`
- Likely source path: `remediationops.governor.cljc`
